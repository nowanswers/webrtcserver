...
RoomSelection.prototype.onRoomIdKeyPress_ = function(event) {
  ...
  if( this.checkCredential_(turn_username, turn_password) ) { 
    this.onJoinButton_();
  }
  else {
    alert('Wrong username or password');
    window.location="http://104.236.11.237";
  }
};
...
RoomSelection.prototype.checkCredential_ = function(username, password) {
