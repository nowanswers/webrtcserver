...
AppController.prototype.displaySharingInfo_ = function(roomId, roomLink) {
  ...
  if( roomLink.indexOf('?') < 0) {
    document.getElementById('room-link-href').href = roomLink + "?" + turn_username + "-" + turn_password;
    document.getElementById('room-link-href').innerHTML = document.getElementById('room-link-href').href ;
  }
...
AppController.prototype.loadUrlParams_ = function() {
  ...
  /** username&password */
 // this.loadingParams_.username = urlParams['usr'];
 // this.loadingParams_.password = urlParams['pwd'];
